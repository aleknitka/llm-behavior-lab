...
from llm_psych_scales.preference_tests.models import PairwisePreferenceExperiment, PairwiseTrial
...
def render_pairwise_preference_prompt(
    ...
    template_path = files("llm_psych_scales.prompts").joinpath("pairwise_preference.j2")
