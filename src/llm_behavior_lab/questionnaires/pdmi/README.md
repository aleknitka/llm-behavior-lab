...
The executable `default` scoring model calculates arithmetic means for the eight
source subscales plus the overall emotional and reasoned item sets. Scores range
from 1 to 5, with higher values indicating more of the named decision-making style.
Experiment-computed reliability is stored separately from the source alpha values.
